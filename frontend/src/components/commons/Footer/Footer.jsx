const Footer = () => {
  return (
    <footer className="bg-white/50 backdrop-blur-xl border-t border-white/5 py-16 px-6 md:px-20 mt-20">
      {/* Changed to grid-cols-4 to accommodate the new section */}
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-black text-sm leading-relaxed max-w-[300px]">
        ...
        <div className="flex flex-col gap-6">
          ...
          <ul className="flex flex-col gap-4 text-sm text-black font-medium">
        ...
        {/* NEW Section 3: Other links */}
        <div className="flex flex-col gap-6">
          <h5 className="text-sm font-black uppercase tracking-widest">Other Links</h5>
          <ul className="flex flex-col gap-4 text-sm text-black font-medium">
            <li className="hover:text-white transition-colors cursor-pointer">
              <a href="https://www.tropicos.org/project/fop" target="_blank" rel="noopener noreferrer">Flora of Pakistan</a>
            </li>
            <li className="hover:text-white transition-colors cursor-pointer">
              <a href="https://cpc.uok.edu.pk/" target="_blank" rel="noopener noreferrer">Centre for plant conservation</a>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto border-t border-black mt-16 pt-8 text-[10px] uppercase tracking-[0.2em] text-white/20 font-bold flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-black">© 2026 KUH | Powered by Muneer Khan</p>
