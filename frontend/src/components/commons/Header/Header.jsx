...
//   return (
//   <header className="fixed top-0  left-0 right-0 z-[100] flex items-center justify-between px-2  bg-white/30 backdrop-blur-[40px] backdrop-brightness-[0.7] border-b border-none">
// {/* 1. Logo Section (Left) */}
// <Link to="/home" className="flex  group shrink-0 py-2 overflow-visible">
//   <img 
//     src={herbariumlogo} 
//     alt="Flora-Digitalis Icon" 
//     className="h-10 sm:h-12 md:h-15 w-auto object-contain object-left scale-[2.5] origin-left   duration-300" 
//   />
// </Link>
